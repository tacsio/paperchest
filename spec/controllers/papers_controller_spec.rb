  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved paper as @paper" do
        ...
        post :create, {:paper => { "title" => "invalid value" }}, valid_session
        assigns(:paper).should be_a_new(Paper)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested paper" do
        ...
        Paper.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => paper.to_param, :paper => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the paper as @paper" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Paper.any_instance.stub(:save).and_return(false)
        put :update, {:id => paper.to_param, :paper => { "title" => "invalid value" }}, valid_session
        assigns(:paper).should eq(paper)
      end
